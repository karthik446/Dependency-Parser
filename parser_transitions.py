...
def minibatch_parse(sentences, model, batch_size):
    ...
    # batch1 = unfinished_parses[:batch_size]
    # print("b;e")
    ...
    while unfinished_parses:
        ...
        for parse, transition in zip(batch, transitions):
            ...
            remaining = []
            for e in batch:
                if not (len(e.stack) == 1 and len(e.buffer) == 0):
                    remaining.append(e)
            unfinished_parses = remaining + unfinished_parses[batch_size:]
